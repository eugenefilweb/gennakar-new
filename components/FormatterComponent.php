...
class FormatterComponent extends \yii\i18n\Formatter
{
    ...
    public function asDateFormat($date='', $format='m/d/Y h:i A')
    {
        if (!$date) {
            return;
        }
    ...
    public function asDateToTimezone($date='', $format='m/d/Y h:i A', $timezone="")
    {
    ...
    public function asDistance($meters, $unit='m') 
    {
        $number = 0;
        ...
        switch ($unit) {
            case 'km':
                $number = $meters / 1000; break;
            case 'cm':
                $number = $meters * 100; break;
            case 'mm':
                $number = $meters * 1000; break;
            case 'ft':
                $number = $meters * 3.2808; break;
            case 'yd':
                $number = $meters * 1.0936; break;
            case 'mi':
                $number = $meters * 0.000621; break;
            default:
                $number = $meters; break;
        }
    ...
    public function asImplodeList($list, $glue = ', ', $conjunction = 'and') 
    {
        $last = array_pop($list);
        if ($list) {
