...
$config = [
    ...
    'aliases' => [
        ...
        // '@consoleWebroot' => dirname(__DIR__) . '/web', // local
        '@consoleWebroot' => dirname(__DIR__) . '/../public_html/gennakar', // live
    ],
    'components' => [
        ...
        'assetManager' => [
            ...
            'basePath' => __DIR__ . '/../web/assets', // local
            // 'basePath' => __DIR__ . '/../../public_html/gennakar/assets', //live
        ],
