...
class StatementController extends Controller 
{
    ...
    {
        return $this->asJson(
            Statement::findByKeywords($keywords, ['id'])
        );
    }
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search(['StatementSearch' => App::queryParams()]);
    ...
    {
        $model = Statement::controllerFind($id);
    ...
    /**
     * Duplicates a new Statement model.
     * If duplication is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionDuplicate($id)
    {
        $originalModel = Statement::controllerFind($id);
        $model = new Statement();
