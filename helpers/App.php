...
class App {
	...
	public static function absoluteUrl($str='')
	{
		return self::request()->absoluteUrl . $str;
	}
    ...
    public static function for($number=0, $function='', $glue=' ')
    {
        $content = [];
    	for ($i=0; $i < $number; $i++) { 
    ...
    public static function isEven($num = 0)
    {
    	return $num % 2 == 0;
    }
}