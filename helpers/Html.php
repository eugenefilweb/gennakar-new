...
class Html extends \yii\helpers\Html
{
    ...
    public static function exportButton($params, $force_show=false)
    {
        if (($params['showExportButton'] ?? '') || $force_show) {
    ...
    public static function createButton($params)
    {
        ...
        if (isset($params['searchModel'])) {
            if ($params['searchModel']->hasProperty('createLabel')) {
                $title = $params['searchModel']->createLabel;
            }
        }
    ...
    public static function convert_army_to_regular($time=0)
    {
        $time = (int) $time;
        ...
        return date("g:i a", strtotime(implode(':', [$hours, $minutes])));
    }
