...
abstract class ActiveRecord extends \yii\db\ActiveRecord
{
    ...
    public static function mapRecords($withDraft = true)
    {
        $data = App::keyMapParams('record_status');

        if ($withDraft === false) {
            if (isset($data[self::RECORD_DRAFT])) {
                unset($data[self::RECORD_DRAFT]);
            }
        }
        return $data;
    }
    ...
    public function getCreatedByName()
    {
        if ($this->_createdByName === null) {
            if(($model = $this->createdBy) != null) {
                $this->_createdByName = $model->fullname;
            }
        }
    ...
    public function getUpdatedByName()
    {
        if ($this->_updatedByName === null) {
            if(($model = $this->updatedBy) != null) {
                $this->_updatedByName = $model->fullname;
            }
        }
    ...
    public function getFileViewerUrl($token)
    {
        return App::if(File::findByToken($token), fn($file) => $file->viewerUrl);
    }
    ...
    public function theValue($attribute = '', $default = 'N/A')
    {
