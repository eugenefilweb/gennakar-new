...
class Event extends ActiveRecord
{
    ...
    {
        return App::if($this->eventMembers, false, $this->status == self::PENDING);
    }
    ...
    public function rules()
    {
        ...
        return $this->setRules([
            ...
            [
                ['amount'], 
                'required', 'when' => function($model) {
                    return $model->assistance_type == self::CASH;
                },
                'whenClient' => "function (attribute, value) {
                    return $('#event-assistance_type').val() == {$CASH};
                }"
            ],
            [
                'assistance_type', 'in', 
    ...
    public function gridColumns()
    {
        return [
            ...
            'date_from' => ['attribute' => 'date_from', 'format' => 'dateFormat'],
            'date_to' => ['attribute' => 'date_to', 'format' => 'dateFormat'],
            'beneficiaries' => [
                'label' => 'BENEFICIARIES',
    ...
    public function getMemberSearch()
    {
        ...
        $searchModel->voter = $this->beneficiaries['voter'] ?? $searchModel->voter;
        $searchModel->social_pension_status = $this->beneficiaries['social_pension_status'] ?? $searchModel->social_pension_status;
    ...
    public function getPhotoUrl()
    {
        ...
        $this->photo = $this->photo ?: App::setting('image')->image_holder;

        return Url::to(['file/display', 'token' => $this->photo]);
    }
