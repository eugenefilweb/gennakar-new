...
class Household extends ActiveRecord
{
    ...
    const STEP_FORM_VIEW = [
        ...
        6 => [
            ...
            'slug' => 'dafac',
            'title' => 'WAC',
            'description' => 'Watershed Assistance Card',
        ],
    ];
    ...
    {
        return App::if($this->members, false, parent::getCanDelete());
    }
    ...
    public function rules()
    {
        return $this->setRules([
            ...
            [['longitude', 'latitude', 'altitude'], 'required', 'on' => 'map'],
    ...
    public function getTotalFamilyComposition()
    {
        ...
        return ($totalMembers == 0)? 0: $totalMembers - 1;
    }
    ...
    public function getAddress()
    {
        ...
        if ($this->barangay_id) {
            $address[] = "Brgy {$this->barangayName}";
        }
        ...
        if ($this->street && trim($this->street) != 'NONE') {
