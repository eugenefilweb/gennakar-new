...
class Member extends ActiveRecord
{
    ...
    {
        return App::if($this->eventMembers || $this->transactions, false, parent::getCanDelete());
    }
    ...
    public function rules()
    {
        return $this->setRules([
            ...
            [['photo'], 'string'],
            [['last_name', 'middle_name', 'first_name', 'email', 'contact_no', 'source_of_income', 'pensioner_from'], 'string', 'max' => 255],
    ...
    public function getQrCode()
    {
        ...
        } catch (\chillerlan\QRCode\Output\QRCodeOutputException $e) {
    ...
    public static function findByKeywordsEvent($event_id, $keywords='', $attributes='', $limit=10)
    {
        ...
        return parent::findByKeywordsData($attributes, function($attribute) use($keywords, $limit, $event) {
            return self::find()
                ...
                ->andWhere(['h.barangay_id' => $event->barangay_ids])
