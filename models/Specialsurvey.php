...
class Specialsurvey extends ActiveRecord
{
    ...
    public function rules()
    {
        return $this->setRules([
            ...
            [['date_of_birth', 'date_survey', 'survey_name', 'household_no'], 'safe'],
            [['civil_status', 'house_no','purok', 'sitio', 'barangay', 'municipality', 'province', 'religion'], 'string', 'max' => 32],
    ...
    public function gridColumns()
    {
        return [
            ...
            'fullname' => ['attribute' => 'first_name', 'format' => 'raw', 'value' => 'fullname', 'label' => 'FULLNAME'],
          ...
          //  'house_no' => ['attribute' => 'house_no', 'format' => 'raw'],
           ...
           // 'religion' => ['attribute' => 'religion', 'format' => 'raw'],
            ...
            'remarks' => ['attribute' => 'remarks', 'format' => 'raw','visible'=>false],
        ];
    }
    ...
    public static function monthFilter()
    {
