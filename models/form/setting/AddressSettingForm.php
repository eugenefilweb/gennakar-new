...
class AddressSettingForm extends SettingForm
{
    ...
    {
        return [
            [['region_id', 'province_id', 'municipality_id', 'zip', 'blk_lot_street'], 'required'],
            ...
            [['zip', 'blk_lot_street'], 'string', 'max' => 225],
        ];
    }
    ...
    {
        return [
            ['name' => 'blk_lot_street', 'default' => 'Municipal Bldg., Brgy. Anoling'],
            ['name' => 'zip', 'default' => '4216'],
            'region_id' => [
                'name' => 'region_id',
