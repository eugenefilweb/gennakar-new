...
class ImageSettingForm extends SettingForm
{
    ...
    public $map_icon_start;
    public $map_icon_end;

    public $responders_logo;
    ...
    {
        return [
            [['primary_logo', 'secondary_logo', 'image_holder', 'favicon', 'household_map_icon', 'id_template', 'municipality_logo', 'social_welfare_logo', 'other_logo', 'senior_citizen_logo', 'solo_parent_logo', 'pyap_logo', 'doh_logo', 'baktom_logo', 'map_icon_start', 'map_icon_end', 'responders_logo'], 'string'],

            [['baktom_logo', 'senior_citizen_logo', 'solo_parent_logo', 'pyap_logo', 'primary_logo', 'secondary_logo', 'image_holder', 'favicon', 'household_map_icon', 'id_template', 'municipality_logo', 'social_welfare_logo', 'other_logo', 'brand_logo', 'doh_logo', 'map_icon_start', 'map_icon_end', 'responders_logo'], 'safe'],
        ];
    }
