...
class ReportTemplateForm extends SettingForm
{
    ...
    public function setData()
    {
        ...
        $replace = [
            '[MUNICIPALITY_LOGO]' => Url::image($image->municipality_logo, [], true),
            '[PRIMARY_LOGO]' => Url::image($image->primary_logo, [], true),
            '[SECONDARY_LOGO]' => Url::image($image->secondary_logo, [], true),
            '[OTHER_LOGO]' => Url::image($image->other_logo, [], true),
            ...
            '[SOCIAL_WELFARE_LOGO]' => Url::image($image->social_welfare_logo, [], true),
            ...
            '[BAKTOM_LOGO]' => Url::image($image->baktom_logo, [], true),
