	...
	setup(props, { emit }) {
        ...
        const showTimesent = (index) => {
            ...
            if (previousMessage) {
                ...
                if (currentMessage.created_by != previousMessage.created_by) {
                    return true;
                }
                if (currentMessage.isSender != previousMessage.isSender) {
                    return true;
                }
        ...
        const messageClass = (index) => {
            ...
            if (nextMessage) {
                if (currentMessage.created_by != nextMessage.created_by) {
                    return 'mb-5';
                }
                ...
                if (currentMessage.type != nextMessage.type) {
                    return 'mb-5';
                }
