...
--
-- Host: localhost:3306
-- Generation Time: Apr 18, 2022 at 01:29 AM
...
CREATE TABLE `country` (
  ...
  `AlphaCode` varchar(3) DEFAULT NULL
...
INSERT INTO `country` (`country`, `CountryName`, `AlphaCode`) VALUES
(4, 'Afghanistan', 'AFG'),
(8, 'Albania', 'ALB'),
(12, 'Algeria', 'DZA'),
...
(818, 'Egypt', 'EGY'),
(826, 'United Kingdom of Great Britain and Northern Irela', 'GBR'),
(830, 'Channel Islands', '[No'),
(831, 'Guernsey', 'GGY'),
(832, 'Jersey', 'JEY'),
(833, 'Isle of Man', '[No'),
...
(858, 'Uruguay', 'URY'),
(860, 'Uzbekistan', 'UZB'),
(862, 'Venezuela (Bolivian Republic of)', 'VEN'),
...
ALTER TABLE `country`
  ...
  ADD KEY `countryIndex` (`country`,`CountryName`,`AlphaCode`);
COMMIT;
