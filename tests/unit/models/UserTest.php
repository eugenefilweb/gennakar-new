...
class UserTest extends \Codeception\Test\Unit
{
    ...
    public function testCreateWithNiceNameSuccess()
    {
        $model = new User($this->data());
        $model->nice_name = 'Juan DelaCruz';
        expect_that($model->save());

        $this->tester->seeRecord('app\models\UserMeta', [
            'user_id' => $model->id
        ]);
        expect($model->profile->first_name)->equals('Juan');
        expect($model->profile->last_name)->equals('DelaCruz');
    }
