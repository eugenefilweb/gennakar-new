...
class AllowanceSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['AllowanceSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'AllowanceSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
