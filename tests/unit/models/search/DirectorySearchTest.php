...
class DirectorySearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['DirectorySearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'DirectorySearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
