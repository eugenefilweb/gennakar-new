...
class EventMemberSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['EventMemberSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'EventMemberSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
