...
class HouseholdMemberSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['HouseholdMemberSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'HouseholdMemberSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
