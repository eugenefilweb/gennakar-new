...
class LibrarySearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['LibrarySearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'LibrarySearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
