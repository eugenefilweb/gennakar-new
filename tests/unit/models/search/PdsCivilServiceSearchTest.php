...
class PdsCivilServiceSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['PdsCivilServiceSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'PdsCivilServiceSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
