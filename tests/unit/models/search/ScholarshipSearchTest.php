...
class ScholarshipSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['ScholarshipSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'ScholarshipSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
