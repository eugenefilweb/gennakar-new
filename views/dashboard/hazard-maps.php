...
$this->params['searchModel'] = new \app\models\search\DashboardSearch(['searchLabel' => 'Hazard Map']); 
$this->params['activeMenuLink'] = '/dashboard/hazard-maps';
...
<input type="hidden" name="_csrf" value="iPX1RbXDh83P7TYc8queu6PHgItXTQ3o2coNDwqAAzzbgLcR_vLGovm8R02B_eri7_Tx5A5gadCKpmdIaMVrbg==">            <input type="hidden" id="usermeta-table_name" name="UserMeta[table_name]" value="transactions">            <ul class="navi navi-hover" style="padding: 10px;">
                <li class="navi-item"> 
...
<input type="hidden" name="_csrf" value="iPX1RbXDh83P7TYc8queu6PHgItXTQ3o2coNDwqAAzzbgLcR_vLGovm8R02B_eri7_Tx5A5gadCKpmdIaMVrbg==">            <div class="d-flex">
                <div>
