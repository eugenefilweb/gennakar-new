...
$this->registerJs(<<< JS
    ...
    $('#event-form input[type="checkbox"]').change(function() {
        ...
        if (name == 'pwd[]') {
            ...
            if (val == 1) { // yes
                if (is_checked) {
                    $('.pwd-type-container').show();
                }
                else {
                    $('.pwd-type-container').hide();
                }
            }
        }
    ...
    <div class="row" data-sticky-container>
        <div class="col">
            ...
            <div class="accordion accordion-solid accordion-toggle-plus" id="accordion-filter">
                ...
                <div class="card" data-title="Indigenous People">
                    <div class="card-header">
                        <div class="card-title collapsed" data-toggle="collapse" data-target="#ip-container" aria-expanded="false">
                            <i class="fas fa-mountain"></i>
                            <span>Indigenous People <?= $searchModel->totalFilterTag('voter') ?></span>
                        </div>
                    </div>
                    <div id="ip-container" class="collapse" data-parent="#accordion-filter">
                        <div class="card-body">
                            <?= Filter::widget([
                                'form' => $form,
                                'model' => $searchModel,
                ...
                <div class="card" data-title="Watershed">
                    <div class="card-header">
                        <div class="card-title collapsed" data-toggle="collapse" data-target="#watershed-container" aria-expanded="false">
                            <i class="fas fa-water"></i>
                            <span>Watershed <?= $searchModel->totalFilterTag('social_pension_status') ?></span>
                        </div>
                    </div>
                    <div id="watershed-container" class="collapse" data-parent="#accordion-filter">
                        <div class="card-body">
                            <?= Filter::widget([
                                'form' => $form,
                                'model' => $searchModel,
                                'attribute' => 'social_pension_status',
                                'title' => false,
                                'data' => App::keyMapParams('social_pension_status')
                            ]) ?>
                        </div>
                    </div>
                </div>

                <div class="card" data-title="Priority Sector">
                    <div class="card-header">
                        <div class="card-title collapsed" data-toggle="collapse" data-target="#priority-sector-container">
                            <i class="fas fa-user-tag"></i>
                            <span>Priority Sector <?= $searchModel->totalFilterTag('solo_parent') ?></span>
                        </div>
                    </div>
                    <div id="priority-sector-container" class="collapse" data-parent="#accordion-filter">
                        <div class="card-body">
                            <?= Filter::widget([
                                'form' => $form,
                                'model' => $searchModel,
