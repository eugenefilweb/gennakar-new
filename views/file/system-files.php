...
$this->registerJs(<<< JS
    ...
    $(document).on('click', imageContainer, function() {
        ...
        let actionButtons = '<a href="'+ $(this).data('download-url') +'" class="btn btn-primary btn-sm">';
            ...
            actionButtons += '&nbsp; <a href="'+ $(this).data('draw_url') +'" class="btn btn-outline-info btn-sm font-weight-bold" target="_blank"> View </a>';
            // actionButtons += '&nbsp; <a href="'+ $(this).data('draw_url') +'" class="btn btn-outline-warning btn-sm font-weight-bold" target="_blank"> Edit </a>';
