...
<div class="family-composition-container">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="tab-active" role="tabpanel" aria-labelledby="tab-active">
            <div class="mt-10">
                <table class="table table-bordered table-head-solid" id="table-fc">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>name</th>
                    ...
                    <tbody>
                        <?= Html::ifElse(($fc = $model->familyCompositions) != null, function() use($fc) {
        ...
        <div class="tab-pane fade" id="tab-inactive" role="tabpanel" aria-labelledby="tab-inactive">
            <div class="mt-10">
                <table class="table table-bordered table-head-solid" id="table-ifc">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>name</th>
