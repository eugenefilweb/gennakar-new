            ...
            <div class="d-flex align-items-end py-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="text-muted font-weight-bold">Patrol ID: <?= $model->tripId ?></span>
                    </div>
                </div>
            </div>
            <p class="py-2">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?= App::foreach($trees, fn ($tree, $index, $counter) => <<< HTML
                        <tr>
                            <td>{$counter}</td>
                            <td>{$tree->treeNumber}</td>
                            <td>{$tree->common_name}</td>
                            <td>{$tree->kingdom}</td>
                            <td>{$tree->family}</td>
                            <td>{$tree->genus}</td>
                            <td>{$tree->species}</td>
                            <td>{$tree->sub_species}</td>
                            <td>{$tree->varieta_and_infra_var_name}</td>
                            <td>{$tree->taxonomic_group}</td>
                            <td>{$tree->date_encoded}</td>
                            <td>{$tree->createdByName}</td>
                        </tr>
                    HTML) ?>
                </tbody>
            </table>
