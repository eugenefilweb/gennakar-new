...
<div id="printable" style="<?= $style ?? '' ?>">
	...
	<?php echo $this->render('printable2/_page', ['model' => $model]) ?>

	<?php #echo $this->render('printable2/page2', ['model' => $model]) ?>

	<?php #echo $this->render('printable2/page3', ['model' => $model]) ?>

	<div class="page-break"></div>
	<?php echo $this->render('printable2/page4', ['model' => $model]) ?>
</div>