...
<?= App::foreach([
	...
	Html::tag('td', $key, ['class' => 'bg-light-gray pl-7', 'colspan' => 2]),
	Html::tag('td', $obj ? $obj->theValue('name'): '', ['class' => 'text-center', 'colspan' => 2]),
	Html::tag('td', $obj ? $obj->theValue('course'): '', ['class' => 'text-center', 'colspan' => 2]),
