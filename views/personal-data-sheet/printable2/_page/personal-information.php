...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray border-bottom-hidden">2. SURNAME</td>
	<td colspan="9"><?= $model->theValue('surname') ?></td>
</tr>
<tr>
	<td colspan="2" class="bg-light-gray border-bottom-hidden pl-4">FIRST NAME</td>
	<td colspan="6"><?= $model->theValue('first_name') ?></td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray pl-4">MIDDLE NAME</td>
	<td colspan="9"><?= $model->theValue('middle_name') ?></td>
</tr>

<tr>
	<td colspan="2" rowspan="2" class="vertical-align-top bg-light-gray line-height-md">
		3. DATE OF BIRTH
	...
	<td rowspan="2" class="border-right-hidden vertical-align-top nowrap">
		<?= Html::input('checkbox', '', '', [
	...
	<td colspan="3" class="border-bottom-hidden vertical-align-top">Dual Citizenship</td>
</tr>
...
<tr>
	...
	<td class="border-bottom-hidden" colspan="2">
		<label>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">4. PLACE OF BIRTH</td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">5. SEX</td>
	<td>
		<label>
...
<tr>
	<td colspan="2" rowspan="2" class="vertical-align-top bg-light-gray">6. CIVIL STATUS</td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">7. HEIGHT (m)</td>
	<td colspan="2">
		<?= $model->theValue('height') ?>
	</td>
	<td colspan="6" class="line-height-md">
		<div class="d-flex justify-content-around">
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray"> 8. WEIGHT (kg) </td>
	<td colspan="2">
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">9. BLOOD TYPE</td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">10. GSIS ID NO.</td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">11. PAG-IBIG ID NO</td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">12. PHILHEALTH NO.</td>
...
<tr class="row-height">
	<td colspan="2" class="bg-light-gray">13. SSS NO.</td>
	<td colspan="2"><?= $model->theValue('sss_no') ?></td>
	<td class="bg-light-gray">19. TELEPHONE NO.</td>
	<td colspan="6"> <?= $model->theValue('telephone_no') ?> </td>
</tr>

<tr class="row-height">
	<td colspan="2" class="bg-light-gray">14. TIN NO</td>
	<td colspan="2"><?= $model->theValue('tin_no') ?> </td>
	<td class="bg-light-gray">20. MOBILE NO</td>
	<td colspan="6"> <?= $model->theValue('mobile_no') ?></td>
</tr>

<tr class="row-height">
	<td colspan="2" class="bg-light-gray">15. AGENCY EMPLOYEE NO.</td>
	<td colspan="2"><?= $model->theValue('agency_employee_no') ?></td>
	<td class="bg-light-gray">21. E-MAIL ADDRESS <small>(if any)</small></td>
	<td colspan="6"> <?= $model->theValue('email_address') ?> </td>
</tr>