...
<table border="1">
	<tbody>
		...
		<?= App::foreach($model->workExperiences, fn ($workExperience, $index, $counter) => Html::tag('tr', implode('', [
			Html::tag('td', $counter . '-' . $workExperience->theValue('from'), ['class' => 'text-center']),
