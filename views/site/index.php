...
<div class="hero">
    <div class="container">
        <div class="d-flex justify-content-between pt-20">
            <div>
                <img src="<?= App::baseUrl('default/brand-logo-colored.png') ?>" class="logo">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="img-container">
                        <img src="<?= App::baseUrl('default/accessgov.png') ?>" class="img-fluid accessgov">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row icon">
            <div class="col-md-3">
                <div class="text-center">
                    <a href="#" class="btn btn-icon btn-circle">
                        <img src="<?= App::baseUrl('default/how-it-works/database management.png') ?>" class="img-fluid">
                    </a>
                </div>
            ...
            <div class="col-md-3">
                <div class="text-center">
                    <a href="#" class="btn btn-icon btn-circle">
                        <img src="<?= App::baseUrl('default/how-it-works/reports generation.png') ?>" class="img-fluid">
                    </a>
                </div>
            ...
            <div class="col-md-3">
                <div class="text-center">
                    <a href="#" class="btn btn-icon btn-circle">
                        <img src="<?= App::baseUrl('default/how-it-works/budget management.png') ?>" class="img-fluid">
                    </a>
                </div>
            ...
            <div class="col-md-3">
                <div class="text-center">
                    <a href="#" class="btn btn-icon btn-circle">
                        <img src="<?= App::baseUrl('default/how-it-works/digital transactions.png') ?>" class="img-fluid">
                    </a>
                </div>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="<?= App::baseUrl('default/sneak-peek/certification.png') ?>">
                        </div>
                        <div class="item">
                            <img src="<?= App::baseUrl('default/sneak-peek/household.png') ?>">
                        </div>
                        <div class="item">
                            <img src="<?= App::baseUrl('default/sneak-peek/transaction.png') ?>">
                        </div>
                        <div class="item">
                            <img src="<?= App::baseUrl('default/sneak-peek/budget.png') ?>">
                        </div>
                    </div>
...
<div class="copyright">
    <div class="container">
        <div class="d-flex justify-content-between">
            <div class="d-flex">
                <div class="img-container">
                    <img src="<?= App::baseUrl('default/icon-white-blue.png') ?>">
                </div>
                <div class="text">
                    <p>
