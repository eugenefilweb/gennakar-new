...
?>
<div class="tech-issue-view-page" id="tech-issue-page" v-cloak data-token="<?= $model->token ?>">
        <?= Anchors::widget([
        ...
        <!-- <div class="btn-group dropdown">
            <button type="button" class="btn btn-outline-secondary font-weight-bold" fdprocessedid="7kk8q">Change Status</button>
            <button type="button" class="btn btn-outline-secondary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" fdprocessedid="2l0t1">
                <span class="sr-only">Toggle Dropdown</span>
            </button>
            <div class="dropdown-menu">
                <?= App::foreach(App::params('tech_issue_status'), fn ($tis) => $tis['id'] != $model->status? Html::tag('a', $tis['label'], [
                    'data-id' => $tis['id'],
                    'data-label' => $tis['label'],
                    'class' => 'change-status dropdown-item text-' . $tis['class'],
                    'href' => '#!'
                ]): '') ?>
            </div>
        </div> -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?php $this->beginContent('@app/views/layouts/_card_wrapper.php', [
                ...
                <div class="timeline timeline-3 overflow-auto pr-2" style="height: 80vh" ref="conversationsContainer" @scroll="messageScroll">
