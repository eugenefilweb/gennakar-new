			    ...
			    <?= Webcam::widget([
                    ...
                    'ajaxSuccess' => <<< JS
                        let html = '<div class="image-input image-input-outline file-container">';
                        	...
                        	html += '<a title="View: '+ s.file.name +'" target="_blank" href="'+ s.src +'0&rotate=-90"><p class="badge badge-secondary mb-1">'+ s.file.truncatedName +'</p></a>';
                        html += '</div>';
                	...
                	<?= Html::foreach($model->imageFiles, function($file) {
						return <<< HTML
							<div class="image-input image-input-outline file-container">
								<div class="image-input-wrapper" style="background-image: url({$file->urlImage});width: 200px"></div>
								...
								<a title="View: {$file->name}" target="_blank" href="{$file->urlImage}0&rotate=-90">
