...
<?php $this->beginContent('@app/views/layouts/_card_wrapper.php', [
    ...
    <ul class="nav nav-tabs nav-bold nav-tabs-line">
        <li class="nav-item" data-tab="role-access">
            <a class="nav-link active" data-toggle="tab" href="#tab-upload">
    ...
    <div class="tab-content">
        <div class="tab-pane fade pt-10" id="tab-create" role="tabpanel" aria-labelledby="tab-create">
        ...
        <div class="tab-pane fade show active pt-10" id="tab-upload" role="tabpanel" aria-labelledby="tab-upload">
            <div class="row">
                <div class="col-md-5">
                    <?= Html::if(
