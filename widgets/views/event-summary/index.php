...
<?php if ($withBeneficiaries): ?>
	<p class="lead text-dark-75 mt-10 font-weight-bold"> BENEFICIARIES </p>
	<table class="table table-bordered">
...
<p class="lead text-dark-75 mt-10 font-weight-bold"> PARTICIPATION SUMMARY </p>
<table class="table table-bordered">
	<thead>
		<th>beneficiaries</th>
...
<p class="lead text-dark-75 mt-10 font-weight-bold"> PARTICIPATION DATA </p>
...
<?php if (($allFiles = $event->allFiles) != null): ?>
	<p class="lead text-dark-75 mt-10 font-weight-bold"> FILES / DOCUMENTS </p>
	<table class="table table-bordered app-iconbox" id="table-file">
		<thead>
			<tr>
