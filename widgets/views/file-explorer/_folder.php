...
?>
<div class="col-md-2">
	<div class="folder-container mb-2" data-path="<?= $folder['path'] ?>" data-toggle="tooltip" title="Double click to open, Left click to see folder actions" data-placement="right">
