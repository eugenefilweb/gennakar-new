...
$js = <<< JS
    var selectedImage = {
        ...
        imageActionBtn = [container, '.td-action_btn'].join(' '),
        ...
        filterTag = [container, '.taglist'].join(' '),
    ...
    $(document).on('change', filterTag, function(e) {
        getMyFiles('{$mainMyImageFilesUrl}?keywords=' + $(searchInput).val() +'&tag=' + $(this).val());
    });
    ...
    $(document).on('click', autoCompleteItems, function() {
        getMyFiles('{$mainMyImageFilesUrl}?keywords=' + $(searchInput).val());
    });
    ...
    $(document).on('click', images, function() {
        ...
        $(imageActionBtn).html('<a href="'+ $(this).data('download-url') +'" class="btn btn-sm btn-secondary font-weight-bold">Download</a> <a target="_blank" href="'+ $(this).data('draw_url') +'" class="btn btn-sm btn-secondary font-weight-bold">View</a>');
                                        ...
                                        <table class="table-bordered font-size-sm">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-action_btn"> None </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
